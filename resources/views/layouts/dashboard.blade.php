...
<html lang="en">
    <head>
        ...
        <title>Dashboard - Waste management system</title>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">Waste managemt system</a>
            <!-- Sidebar Toggle-->
                        ...
                        <div class="nav">
                            ...
                            <!-- <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion"> -->
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="{{route('dustbins.index')}}">Dustbin Management</a>
                                    <a class="nav-link" href="{{route('blocks.index')}}">Block Management</a>
                                    <a class="nav-link" href="{{route('datas.index')}}">Data Management</a>
